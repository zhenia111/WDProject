...
const PriceCard = (props) => {
    ...
    return (
        <>
            <div id='priceCard' className='priceCard   w-auto mx-3  d-flex  flex-column  border border-success text-center mb-5' >
                ...
                <ul className='priceCard__list mt-3 mb-4 mx-auto'>
                    ...
                    {lists.map(({list,id})=>(
                        <li key={id}  className='priceCard__li border-bottom border-dark'>{list}</li>
                    ))}
