            ...
            <div className="myForm">
                <Form className="myForm_window">
                    <Form.Group className=" mb-3" controlId="formBasicEmail">
                        <Form.Label className="myForm_label fs-3 fw-bold">
                            {MY_FORM_DATA.labelEmail}
                        </Form.Label>
                        <InputGroup>
                            <Form.Control
                                className="myForm_control fs-4 p-4"
                                type="email"
                                placeholder={MY_FORM_DATA.placeholderEmail}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPassword">
                        <Form.Label className="myForm_label fs-3 fw-bold">
                            {MY_FORM_DATA.labelPassword}
                        </Form.Label>
                        <InputGroup>
                            <Form.Control
                                className="myForm_control fs-4 p-4"
                                type="password"
                                placeholder={MY_FORM_DATA.placeholderPassword}
                    ...
                    <div className="myForm__btn">
                        <Button
                            variant="success"
                            className="btn bg-success fs-3 w-100"
                            type="submit"
                            onClick={sendData}
                        >
                            {MY_FORM_DATA.btn}
